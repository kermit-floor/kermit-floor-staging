...
function SkirtingCollectionNav() {
  ...
  const collections: {
    ...
    { name: t('elite-100-mm'), href: '/spc-skirting-boards/elite-100-mm-skirting-board', imageUrl: '/images/skirting-boards/elite-100-mm-skirting-board/E1013031/product.jpg', imageHint: 'elite 100mm skirting' },
